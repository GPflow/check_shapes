...
@dataclass
class TestData:
    training_features: torch.Tensor  # [n_training_rows, n_features]
    training_targets: torch.Tensor  # [n_training_rows, 1]
    test_features: torch.Tensor  # [n_test_rows, n_features]
    test_targets: torch.Tensor  # [n_test_rows, 1]
